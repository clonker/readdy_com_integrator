...
class CMakeBuild(build_ext):
    def build_extension(self, ext):
        ...
        cmake_args = [
            ...
            "-DSP_DIR={}".format(sysconfig.get_paths()["purelib"]),
...
setup(
    name="readdy_com_integrator",
    version="0.0.1",
    author="xyz",
    author_email="xyz@gmail.com",
    description="The com project",
    long_description="",
    packages=find_packages(),
    ext_modules=[CMakeExtension("readdy_com.bindings", sourcedir=".")],
